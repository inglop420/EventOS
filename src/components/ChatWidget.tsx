    ...
    const sendMessage = async () => {
        ...
        try {
            ...
            if (webhookUrl && !webhookUrl.includes('your-n8n')) {
                ...
                // Fallback responses when webhook isn't configured
        ...
        <>
                ...
                {!isOpen && (
                    ...
                    >
                        ...
                        {showBubble && (
                            ...
                            >
                                <div className="glass rounded-xl px-4 py-2 text-sm text-white">
                                    <Sparkles className="w-3 h-3 inline mr-1 text-[var(--gold)]" />
                        ...
                        <button
                            ...
                            className="w-14 h-14 rounded-full bg-gradient-to-br from-[var(--gold)] to-[var(--gold-dark)]
                flex items-center justify-center shadow-lg pulse-gold
                hover:from-[var(--gold-light)] hover:to-[var(--gold)] transition-all"
                        >
            ...
            <AnimatePresence>
              ...
              glass rounded-2xl overflow-hidden flex flex-col shadow-2xl"
                    >
                        ...
                        <div className="px-4 py-3 border-b border-white/10 flex items-center justify-between bg-gradient-to-r from-[var(--green-dark)] to-[var(--black)]">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <p className="text-sm font-semibold text-white">Asistente El Paraíso</p>
                    ...
                    focus:border-[var(--gold)] focus:outline-none text-sm text-white
                    placeholder:text-gray-500 transition"
                                />
                                <button
                                    onClick={sendMessage}
                                    disabled={!input.trim() || isLoading}
                                    className="w-10 h-10 rounded-full bg-[var(--gold)] flex items-center justify-center
                    hover:bg-[var(--gold-light)] disabled:opacity-30 transition"
                                >
